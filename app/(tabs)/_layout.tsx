...
function tabBarIcon(name: React.ComponentProps<typeof FontAwesome>["name"]) {
      ...
      <View style={ls.content}>
        ...
        >
          <Tabs.Screen
            ...
            options={{
              title: "Overview",
              tabBarIcon: tabBarIcon("line-chart"),
            }}
          />
          <Tabs.Screen
          ...
          <Tabs.Screen
            ...
            options={{
              title: "Transactions",
              tabBarIcon: tabBarIcon("exchange"),
            }}
          />
          <Tabs.Screen
            name="deposits"
