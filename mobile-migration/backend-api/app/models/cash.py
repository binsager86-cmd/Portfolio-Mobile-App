...
class CashDeposit(Base):
    ...
    # 'deposit' | 'withdrawal' — drives sign convention for cash recalc
    source: Mapped[Optional[str]] = mapped_column(String(20), nullable=True, default="deposit")
    ...
    # 1 = include in TWR/MWRR analysis, 0 = exclude (e.g. internal transfer)
    include_in_analysis: Mapped[Optional[int]] = mapped_column(Integer, nullable=True, default=1)
    fx_rate_at_deposit: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
