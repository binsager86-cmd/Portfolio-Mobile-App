...
function signInWebRedirect(): void {
  ...
  // CSRF defence: generate a random state token, stash it in localStorage
  // (NOT sessionStorage — some browsers / privacy modes wipe sessionStorage
  // across the full-page Google redirect, which silently breaks login),
