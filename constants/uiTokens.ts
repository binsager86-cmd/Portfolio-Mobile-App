...
export const UITokens = {
  ...
  // ── Platform-split elevation presets (sm / md / lg) ─────────────
  // Use these when you need named semantic levels without cross-platform
  // shadow style duplication.  On iOS each key is a shadow object;
  // on Android it collapses to a Material elevation integer.
  //
  //   style={[styles.card, UITokens.elevations.md]}
  elevations: {
    sm: {
      shadowColor: "#000",
