...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "fundamentals", icon: "flask", path: "/(tabs)/fundamental-analysis", minLevel: "advanced" },
  { label: "tradeSignals", icon: "signal", path: "/(tabs)/trade-signals", minLevel: "advanced" },
  ...
  { label: "alerts", icon: "bell", path: "/(tabs)/alerts", minLevel: "advanced" },
  ...
  { label: "integrity", icon: "stethoscope", path: "/(tabs)/integrity", section: "sectionSystem", minLevel: "normal" },
  { label: "backup", icon: "cloud-download", path: "/(tabs)/backup", minLevel: "normal" },
